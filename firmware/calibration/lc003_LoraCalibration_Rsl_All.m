...
versionStrTrain = ['loraFitRsl_All_' datestr(today,'yyyy_mm_dd')];
disp(versionStrTrain)
versionStrMdl   = ['loraFitRsl_Mdl_' datestr(today,'yyyy_mm_dd')];
disp(versionStrMdl)
display(newline)
dailyString        = "lora_Rsl_All_Daily";
dailyStringImp     = "lora_Rsl_All_Daily_Imp";
disp(dailyString)
display(newline)          
...
for nodeIndex = 1:length(loraIDs)
    ...
    for targetIndex = 1: length(mintsTargets)              
        ...
        OutDescription='Lora Calibration';
